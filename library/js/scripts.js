		...
		if (width >= 768){
			if ($(window).scrollTop() > 250){
                if ($sidebar.length) {
                    ...
                    $sidebarSecondary.css('top',($sidebar.offset().top + $sidebar.outerHeight() + 140));
                    ...
                    if (($sidebarSecondary.offset().top + $sidebarSecondary.outerHeight()) > ($main.offset().top + $main.outerHeight())){
                        $sidebar.css('bottom',$sidebarSecondary.outerHeight() + 130);
                    ...
                    $sidebarSecondary.css('top',($(window).scrollTop() + 130));
                    $sidebarSecondary.css('bottom','auto');
                    if (($sidebarSecondary.offset().top + $sidebarSecondary.outerHeight()) > ($main.offset().top + $main.outerHeight())){
                        $sidebarSecondary.css('bottom','1em');
                        $sidebarSecondary.css('top','auto');
