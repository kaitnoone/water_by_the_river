...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					  <?php
                          $sidebar_menu = get_field("sidebar_navigation");
                      ?>
				...
				<div id="inner-content" class="wrap clearfix">
					...
					<div class="main twelvecol first clearfix" role="main">
                            ...
                            <article class='sidebar-nav primary' id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
